...
# AUTHOR 'CYBEROOVE'
#////////THIS VERSION IS LITE, AND DESIGNED TO INSTALL AND RUN ALL THE TOOLS WITHOUT METASPLOIT AND WIRESHARK
...
if args.delete:
    ...
    dependencies = ['curl', 'build-essential', 'libreadline-dev', 'libssl-dev', 'libpq5', 'libpq-dev', 'libreadline5', 'libsqlite3-dev', 'openjdk-8-jre-headless', 'xtightvncviewer', 'libxml2-dev', 'libxslt1-dev', 'libyaml-dev', 'autoconf', 'zlib1g-dev', 'git', 'python3-pip', 'libpython3-dev', 'libpq-dev', 'tor', 'proxychains']

    # List of tool directories to be deleted
    tools = ['sqlmap', 'nmap', 'social-engineer-toolkit', 'wifite2']
